      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        ...
        >
          <div className="w-full max-w-sm">
            <div className="mb-8 text-center">
              ...
              <p className="text-muted-foreground">Join FinSight AI to start analyzing financial documents</p>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground mt-6">
              ...
              <a href="/sign-in" className="text-primary hover:text-primary-light font-medium">
                Sign in
              </a>
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">Get started with AI-powered financial analysis</p>
          </motion.div>
        </motion.div>
      </div>
    </div>
